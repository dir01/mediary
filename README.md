...
```
$ curl -X POST '/jobs'
{"status": "accepted", "id": "05416c6c8a5a5157205dd7ff50d1abb7"}
```
...
```
$ curl -X GET '/jobs/05416c6c8a5a5157205dd7ff50d1abb7'
{
  ...
  "params": {
    ...
    "uploadUrl": "http://localhost:59542/some-bucket/some-path/some-file.some-ext?X-Amz-Algorithm=AWS4-HMAC-SHA256\u0026X-Amz-Credential=dummy%2F20220917%2F%2Fs3%2Faws4_request\u0026X-Amz-Date=20220917T091445Z\u0026X-Amz-Expires=900\u0026X-Amz-Security-Token=dummy\u0026X-Amz-SignedHeaders=host\u0026x-id=PutObject\u0026X-Amz-Signature=eec201e19935da8d5f3a14d30e929091cddab90432638486c6ff71897b50d814"
  },
  "id": "05416c6c8a5a5157205dd7ff50d1abb7",
  "status": "downloading"
}
```
