...
type MediaProcessorMock struct {
	...
	funcConcatenate          func(filepaths []string, audioCodec string) (resultFilepath string, err error)
	inspectFuncConcatenate   func(filepaths []string, audioCodec string)
...
func (mmConcatenate *mMediaProcessorMockConcatenate) Expect(filepaths []string, audioCodec string) *mMediaProcessorMockConcatenate {
	...
	mmConcatenate.defaultExpectation.params = &MediaProcessorMockConcatenateParams{filepaths, audioCodec}
...
func (mmConcatenate *mMediaProcessorMockConcatenate) Inspect(f func(filepaths []string, audioCodec string)) *mMediaProcessorMockConcatenate {
...
func (mmConcatenate *mMediaProcessorMockConcatenate) Set(f func(filepaths []string, audioCodec string) (resultFilepath string, err error)) *MediaProcessorMock {
	if mmConcatenate.defaultExpectation != nil {
...
// Then helper
func (mmConcatenate *mMediaProcessorMockConcatenate) When(filepaths []string, audioCodec string) *MediaProcessorMockConcatenateExpectation {
	if mmConcatenate.mock.funcConcatenate != nil {
		mmConcatenate.mock.t.Fatalf("MediaProcessorMock.Concatenate mock is already set by Set")
	}
	...
	expectation := &MediaProcessorMockConcatenateExpectation{
		...
		params: &MediaProcessorMockConcatenateParams{filepaths, audioCodec},
	}
...
func (mmConcatenate *MediaProcessorMock) Concatenate(filepaths []string, audioCodec string) (resultFilepath string, err error) {
	...
	if mmConcatenate.inspectFuncConcatenate != nil {
		mmConcatenate.inspectFuncConcatenate(filepaths, audioCodec)
	}

	mm_params := &MediaProcessorMockConcatenateParams{filepaths, audioCodec}
	...
	if mmConcatenate.ConcatenateMock.defaultExpectation != nil {
		...
		mm_got := MediaProcessorMockConcatenateParams{filepaths, audioCodec}
	...
	if mmConcatenate.funcConcatenate != nil {
		return mmConcatenate.funcConcatenate(filepaths, audioCodec)
	}
	mmConcatenate.t.Fatalf("Unexpected call to MediaProcessorMock.Concatenate. %v %v", filepaths, audioCodec)
	return
}
